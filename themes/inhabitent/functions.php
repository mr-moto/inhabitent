...
function red_starter_scripts() {
	$script_url = get_template_directory_uri() . '/build/js/index.min.js';

	wp_enqueue_style( 'red-starter-style', get_stylesheet_uri() );
	wp_enqueue_script( 'jquery' );
	
	wp_enqueue_script( 'search-form', $script_url,  array( 'jquery' ), 1.0, true );

	wp_enqueue_script( 'red-starter-skip-link-focus-fix', get_template_directory_uri() . '/build/js/skip-link-focus-fix.min.js', array(), '20130115', true );

	wp_enqueue_style('font-awesome', '//maxcdn.bootstrapcdn.com/font-awesome/4.6.3/css/font-awesome.min.css', array(), '4.4.0');
